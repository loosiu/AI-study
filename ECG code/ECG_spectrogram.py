...
for i in file_list_AF[0:280]:  
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/train/AFIB/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
    del data
    gc.collect()
...
for i in file_list_AF[280:350]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/val/AFIB/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
        if j == 11:
            del data
            del i
...
for i in file_list_AF[350:438]:
    ...
    for j in range(0,12):        
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/test/AFIB/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
        if j == 11:
            del data
            del i
...
for i in file_list_AT[0:78]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/train/GSVT/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()  
        if j == 11:
            del data
            del i
...
for i in file_list_AT[78:97]:
    ...
    for j in range(0,12):
      ...
      spectrogram(data.iloc[:,j])
      plt.savefig(f'./ECG/spectrogram/lead{j+1}/val/GSVT/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
      plt.close() 
      if j == 11:
            del data
            del i
...
for i in file_list_AT[97:121]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/test/GSVT/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()  
        if j == 11:
            del data
            del i
...
for i in file_list_SA[0:254]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/train/SR/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
        if j == 11:
            del data
            del i
...
for i in file_list_SA[254:318]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/val/SR/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
        if j == 11:
            del data
            del i
...
for i in file_list_SA[318:397]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/test/SR/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close()
        if j == 11:
            del data
            del i
...
for i in file_list_SB[0:2488]:
    ...
    for j in range(0,12):  
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/train/SB/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close() 
        if j == 11:
            del data
            del i
...
for i in file_list_SB[2488:3110]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/val/SB/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close() 
        if j == 11:
            del data
            del i
...
for i in file_list_SB[3110:3888]:
    ...
    for j in range(0,12):
        spectrogram(data.iloc[:,j])
        plt.savefig(f'./ECG/spectrogram/lead{j+1}/test/SB/{i}_lead{j+1}.png', bbox_inches='tight', pad_inches=0)
        plt.close() 
        if j == 11:
            del data
            del i
